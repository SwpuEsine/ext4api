...
<table class="table">
    <tr>
        ...
        <td class="col-md-2">
            <input type="text" name="id" class="form-control" value="${routeSettleCtl.id}"
    ...
    <tr>
        ...
        <td class="col-md-2">
            <input type="text" name="maxTxnAmt" class="form-control" value="${routeSettleCtl.maxTxnAmt}"
                   style="width: 100%;"
    ...
    <tr>
        ...
        <td class="col-md-2"><input type="text" name="instCode" class="form-control" value="${routeSettleCtl.instCode}"
                                    style="width: 100%;" maxlength="4" required/>
        </td>
        <td class="col-md-1"><label>商户地区码使用标志</label></td>
        <td class="col-md-2"><input type="text" name="cityCodeUseFlag" class="form-control"
                                    value="${routeSettleCtl.cityCodeUseFlag}"
                                    style="width: 100%;" maxlength="1" required/></td>
        <td class="col-MD-1"><label>商户地区码</label></td>
        <td class="col-md-2"><input type="text" name="cityCode" class="form-control" value="${routeSettleCtl.cityCode}"
    ...
    <tr>
        ...
        <td class="col-md-2">
            <input type="text" name="mchtNoUseFlag" class="form-control" value="${routeSettleCtl.mchtNoUseFlag}"
                   style="width: 100%;" maxlength="1" required/>
        </td>
        <td class="col-MD-1"><label>指定商户池</label></td>
        <td class="col-md-2">
            <input type="text" name="mchtNo" class="form-control" value="${routeSettleCtl.mchtNo}"
                   style="width: 100%;" required/>
        </td>
        <td class="col-md-1"><label>账户类型使用标志</label></td>
        <td class="col-md-2">
            <input type="text" name="stlmTypeUseFlag" class="form-control" value="${routeSettleCtl.stlmTypeUseFlag}"
                   style="width: 100%;" maxlength="1" required/>
        </td>
    </tr>
    <tr>
        <td class="col-MD-1"><label>商户地区码</label></td>
        <td class="col-md-2"><input type="text" name="stlmType" class="form-control" value="${routeSettleCtl.stlmType}"
                                    style="width: 100%;" required/></td>
        <td class="col-md-1"><label>卡BIN池使用标志</label></td>
        <td class="col-md-2"><input type="text" name="cardBinUseFlag" class="form-control"
                                    value="${routeSettleCtl.cardBinUseFlag}"
                                    style="width: 100%;" maxlength="1" required/></td>
        <td class="col-MD-1"><label>指定卡BIN池</label></td>
        <td class="col-md-2"><input type="text" name="cardBin" class="form-control" value="${routeSettleCtl.cardBin}"
